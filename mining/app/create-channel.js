...
var createChannel = async function(channelName, channelConfigPath, username, orgName) {
	...
	try {
		...
		let options = {
			pem: '../artifacts/channel/crypto-config/ordererOrganizations/example.com/users/Admin@example.com/msp/signcerts/Admin@example.com-cert.pem'
		}

		var url = 'grpc://orderer.example.com:7050'
		var _orderer = client.newOrderer(url,options);
